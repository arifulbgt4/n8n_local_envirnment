...
- After import, manually select the required Postgres and Google Sheets credentials; AI provider API keys come from Control Spreadsheet `04_AI_MODELS` in each workflow.
